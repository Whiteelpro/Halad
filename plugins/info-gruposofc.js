...
let handler = async (m, { conn }) => {
  ...
  async function createImage() {
    try {
      ...
      const { imageMessage } = await generateWAMessageContent({ 
        image: { url: 'https://raw.githubusercontent.com/Whiteelpro/Halad/refs/heads/main/xd.jpg' }  
      }, {
  ...
  const groups = [
    {
      name: 'Grupo Oficial HaladBot-MD',
      desc: 'Grupo principal del bot para convivir con la comunidad',
      buttons: [
        { name: 'Unirse al Grupo', url: 'https://chat.whatsapp.com/ER2YrkCYaqsDUCp6EUJALG?mode=wwc' } // Reemplaza con tu enlace
      ]
    },
    {
      ...
      buttons: [
        { name: 'Unirse al Canal', url: 'https://chat.whatsapp.com/ER2YrkCYaqsDUCp6EUJALG?mode=wwc' } // Reemplaza con tu enlace
      ]
    }
  ]
      ...
      message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.fromObject({
          body: proto.Message.InteractiveMessage.Body.create({
            text: '⚘️ Grupos Oficiales de Halad-MD ⚘️'
          }),
