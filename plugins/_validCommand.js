export async function before(m, { conn }) {
  try {
    ...
    const channelRD = global.channelRD || { id: 'https://chat.whatsapp.com/ER2YrkCYaqsDUCp6EUJALG', name: 'Oficial group hadul' };
    const metanombre = global.metanombre || 'DevHalad';
    ...
    global.rcanal = {
      ...
      contextInfo: {
        ...
        externalAdReply: {
          ...
          sourceUrl: 'https://github.com/Whiteelpro/Halad',
          mediaType: 1,
    ...
    if (validCommand(command, global.plugins)) {
      ...
      if (chat && chat.isBanned) {
        const adReplyMsgBanned = {
          text: `《✦》El bot *Hadul Bot* está desactivado en este grupo.\n\n> ✦ Un *administrador* puede activarlo con el comando:\n> » *${usedPrefix}bot on*`,
          contextInfo: {
        ...
        try {
          ...
          await m.reply(`《✦》El bot *HaladBot-MD* está desactivado en este grupo.\n\n> ✦ Un *administrador* puede activarlo con el comando:\n> » *${usedPrefix}bot on*`);
        }
        return;
      }
