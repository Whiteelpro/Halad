...
let handler = async (m, { conn }) => {
  ...
  try {
    ...
    profilePicUrl = 'https://raw.githubusercontent.com/Whiteelpro/Halad/refs/heads/main/xd.jpg' // Imagen por defecto
  }
      ...
      buttons: [
        {
          ...
          buttonParamsJson: JSON.stringify({
            ...
            url: 'https://chat.whatsapp.com/ER2YrkCYaqsDUCp6EUJALG?mode=wwc'
          })
        },
        {
          name: 'cta_url',
          buttonParamsJson: JSON.stringify({
            ...
            url: 'https://github.com/Whiteelpro/Halad'
          })
        },
        {
          name: 'cta_url',
      ...
      message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.fromObject({
          ...
          footer: proto.Message.InteractiveMessage.Footer.create({
            text: 'Sistema de Perfiles • Halad-MD'
          }),
