...
░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    ...
    const subtitle = chalk.hex('#00eaff').bold('✦ HaladBOT-MD ✦').padStart(40)
    const poweredMsg = chalk.hex('#00eaff').italic('powered by Halad')
    const aiMsg = chalk.hex('#ffb300').bold('🤖 HaladAi - Tu compañera virtual')
    const tips = [
        chalk.hex('#ffb300')('💡 Tip: Usa /help para ver los comandos disponibles.'),
        chalk.hex('#00eaff')('� Síguenos en GitHub para actualizaciones.'),
        chalk.hex('#ff00cc')('✨ Disfruta de la experiencia premium de HaladAi.')
    ]
    const loadingFrames = [
    ...
    console.log(
        chalk.bold.cyanBright(
            boxen(
                chalk.bold('¡Bienvenido a HaladAi!\n') +
